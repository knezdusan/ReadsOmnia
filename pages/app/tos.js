    ...
    <div className={styles.tos}>
      ...
      <div className={styles.tos_box}>
        ...
        <p>
          ...
          ReadsOmnia may issue a warning, temporarily suspend, indefinitely suspend, or terminate your right to use or access all or any part of this website, including any account hereon, without notice, for any reason in ReadsOmnia sole discretion, including, without limitation, violation of the Terms of Use or ReadsOmnia belief that such use or access would violate any applicable law or would be harmful to the interests of, or potentially cause financial loss or legal liability to, ReadsOmnia or another user.
        </p>

        <p>
          <h2>Pricing</h2>
          The prices for items on this website are subject to change. It is possible for the price of an item to change between the time you add it to your shopping cart and the time you check out. Occasionally, an item may be mispriced on the website. In that case, the mispriced item would appear at the incorrect price even upon checkout. No contract will have been formed between you and ReadsOmnia until ReadsOmnia has charged your credit or debit card, or processed another method of payment.
        </p>

        <p>
          <h2>Product Descriptions</h2>
          ReadsOmnia attempts to make the product descriptions as accurate as possible. However, ReadsOmnia does not warrant that the descriptions or other content on this website are accurate, reliable, complete, or current.
        </p>

        <p>
          <h2>Your Account</h2>
          If you register an account with ReadsOmnia on this website, you are responsible for maintaining the confidentiality of your user name and password. You agree to accept full responsibility for all activities that take place under your account or password.<br></br>This website is intended for the use of individuals 18 years or older. Users under 18 may use the website only under the supervision of a parent or legal guardian.
        </p>
        ...
        <p>
          ...
          This website may contain links to other unrelated websites on the Internet. ReadsOmnia is not responsible for the content, accuracy, copyright compliance, decency standards, or other materials on such sites. ReadsOmnia makes no representations or warranties regarding the security of any information you make available to such websites. ReadsOmnia is not liable for any loss or damages incurred as the result of your business dealings with such third parties.
        </p>
        ...
        <p>
          ...
          You will indemnify and hold ReadsOmnia harmless from any claim, demand, loss, liability, costs, or expenses (including reasonable attorney fees), arising out of your misuse of this website, your breach of these Terms of Use, or your violation of the law or any rights of a third party.
        </p>
        ...
        <p>
          ...
          This website is maintained through ReadsOmnia offices located in Portland, Oregon. Accordingly, this agreement shall be deemed to have been made in the United States in the state of Oregon and shall be governed exclusively by the laws of the State of Oregon without regard to any principles of conflicts of law.
        </p>
